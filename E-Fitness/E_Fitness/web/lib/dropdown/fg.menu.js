...
function Menu(caller, options){
	var menu = this;
	var caller = $(caller);
	var container = $('<div id="dropdown-absolute" class="fg-menu-container ui-widget ui-widget-content ui-corner-all">'+options.content+'</div>');
	...
	this.showMenu = function(){
		...
		//editcontainer.parent().show().click(function(){ menu.kill(); return false; });
        container.find("ul.fg-menu").css("display", "block"); //edit
		container.hide().slideDown(options.showSpeed).find('.fg-menu:eq(0)');
		menu.menuOpen = true;
		caller.removeClass(options.loadingState);
		//edit$(document).click(killAllMenus);
		...
		if ($(this).next().is('ul')) {
			$(this)
				...
				.click(function(){ // ----- show the next menu			
		    		...
		    		//checkMenuHeight(nextList); //edit delete
		    		...
		    		var setPrevMenu = function(backlink){
                        ...
                        if (prevList.hasClass('fg-menu-content') && b != undefined) { b.remove(); footer.hide(); }//edit
		    		};		
